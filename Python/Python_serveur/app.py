            ...
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                if mode_game == 0 :
                    if handedness.classification[0].index == 0: #Main gauche
                        ...
                        if hand_sign_id != left_hand_sign_id_last: #Si on a une nouvelle position
                            left_hand_sign_id_last = hand_sign_id
                            jump = False
                            if left_hand_sign_id_last == 0: #Main ouverte: Saut
                                jump = True
                            elif left_hand_sign_id_last == 2 : #Main scissor: shuriken
                                shuriken = True
